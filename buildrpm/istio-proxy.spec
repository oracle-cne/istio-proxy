...
BuildRequires:  lld = 14.0.6
BuildRequires:  llvm-toolset = 14.0.6
BuildRequires:  clang = 14.0.6
...
envoy_src_rpm_version=$(repoquery --show-duplicates  istio-envoy-1.25.*  -q --qf "%{version}" | tail -1)
